...
public class DeleteFrame extends JFrame {
     ...
     * Create the frame.
     */
    public DeleteFrame(JFrame previousFrame) {
        ...
        JLabel lblDeleteRecipe = new JLabel("Delete Coffee Recipe");
    ...
    private void performSearch(String searchText) {
        ...
        try {
            ...
            String query = "SELECT recipe_id, title, measurements, steps FROM coffee WHERE recipe_id LIKE ?";
    ...
    private void performDelete(String searchText) {
        ...
        try {
            ...
            String query = "DELETE FROM coffee WHERE recipe_id LIKE ?";
            PreparedStatement pstmt = connection.prepareStatement(query);
