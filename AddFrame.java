...
public class AddFrame extends JFrame {
	 ...
	 * Create the frame.
	 */
	public AddFrame(JFrame previousFrame) {
		...
		JLabel lblAdd = new JLabel("Add New Recipe For Coffee");
		...
		btnAdd.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        ...
		        Add addRecipe = new Add(AddFrame.this);
		        ...
		        try {
		         ...
		         // Generate a random 3-digit number
		            ...
		            // SQL statement to insert data into the table
		            String sql = "INSERT INTO coffee (recipe_id, title, steps, measurements) VALUES (?, ?, ?, ?)";
