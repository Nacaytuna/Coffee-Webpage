...
public class MilkTeaAddFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AddFrame frame = new AddFrame(previousFrame);
	 ...
	 * Create the frame.
	 */
	public MilkTeaAddFrame(JFrame previousFrame) {
		...
		JLabel lblAdd = new JLabel("Add New Recipe For Milktea");
		...
		btnAdd.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        ...
		        MilkteaAdd addRecipe = new  MilkteaAdd(MilkTeaAddFrame.this);
		        ...
		        try {
		         ...
		         // Generate a random 3-digit number
		            ...
		            // SQL statement to insert data into the table
		            String sql = "INSERT INTO milktea (recipe_id, title, steps, measurements) VALUES (?, ?, ?, ?)";
