...
public class PatryDeleteFrame extends JFrame {
     ...
     * Create the frame.
     */
    public PatryDeleteFrame(JFrame previousFrame) {
        ...
        JLabel lblDeleteRecipe = new JLabel("Delete Patries Recipe");
    ...
    private void performSearch(String searchText) {
        ...
        try {
            ...
            String query = "SELECT recipe_id, title, measurements, steps FROM pastry WHERE recipe_id LIKE ?";
    ...
    private void performDelete(String searchText) {
        ...
        try {
            ...
            String query = "DELETE FROM pastry WHERE recipe_id LIKE ?";
            PreparedStatement pstmt = connection.prepareStatement(query);
